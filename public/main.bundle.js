...
module.exports = "<app-header></app-header>\n<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col-md-12\">\n      <router-outlet></router-outlet>\n      <!--<app-recipes *ngIf=\"selectedFeature === 'recipe'\"></app-recipes>\n      <app-shopping-list *ngIf=\"selectedFeature === 'shopping-list'\"></app-shopping-list> -->\n    </div>\n  </div>\n</div>\n"
...
AuthModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_3__sign_in_sign_in_component__["a" /* SignInComponent */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_routing_module__ = __webpack_require__("../../../../../src/app/app-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__recipes_recipe_service__ = __webpack_require__("../../../../../src/app/recipes/recipe.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__recipes_server_service__ = __webpack_require__("../../../../../src/app/recipes/server.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shopping_list_shopping_list_service__ = __webpack_require__("../../../../../src/app/shopping-list/shopping-list.service.ts");
...
CoreModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_5__recipes_recipe_service__["a" /* RecipeService */], __WEBPACK_IMPORTED_MODULE_7__shopping_list_shopping_list_service__["a" /* ShoppingListService */], __WEBPACK_IMPORTED_MODULE_6__recipes_server_service__["a" /* ServerService */], __WEBPACK_IMPORTED_MODULE_8__auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_9__auth_guard__["a" /* AuthGuard */]],
    })
], CoreModule);
...
var HeaderComponent = (function () {
    function HeaderComponent(recipeService, authService, router) {
...
HeaderComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__recipes_recipe_service__["a" /* RecipeService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__recipes_recipe_service__["a" /* RecipeService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__auth_service__["a" /* AuthService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */]) === "function" && _c || Object])
], HeaderComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__server_service__ = __webpack_require__("../../../../../src/app/recipes/server.service.ts");
...
var RecipeService = (function () {
    function RecipeService(slService, serverService) {
        this.slService = slService;
        this.serverService = serverService;
        this.recipes = [
            new __WEBPACK_IMPORTED_MODULE_2__recipe_model__["a" /* Recipe */]('A test recipe', 'This is simply test', 'http://media3.sailusfood.com/wp-content/uploads/2016/02/cheese-corn-balls.jpg', [new __WEBPACK_IMPORTED_MODULE_3__shared_ingredient_model__["a" /* Ingredient */]('Meat', 1), new __WEBPACK_IMPORTED_MODULE_3__shared_ingredient_model__["a" /* Ingredient */]('French Fries', 20)]),
            new __WEBPACK_IMPORTED_MODULE_2__recipe_model__["a" /* Recipe */]('A test recipe 2', 'This is simply test 2', 'http://media3.sailusfood.com/wp-content/uploads/2016/02/cheese-corn-balls.jpg', [new __WEBPACK_IMPORTED_MODULE_3__shared_ingredient_model__["a" /* Ingredient */]('Buns', 2), new __WEBPACK_IMPORTED_MODULE_3__shared_ingredient_model__["a" /* Ingredient */]('Meat', 2)])
        ];
        this.recipeChanged = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["Subject"]();
    }
    ...
    RecipeService.prototype.saveRecipes = function () {
        this.serverService.saveRecipes(this.recipes).subscribe(function (res) {
            console.log(res);
        });
    };
    RecipeService.prototype.getRecipesFromServer = function () {
        var _this = this;
        this.serverService.getRecipes().subscribe(function (res) {
            console.log(res);
            _this.recipes = res;
            _this.recipeChanged.next(_this.recipes.slice());
        });
    };
...
RecipeService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* Injectable */])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__shopping_list_shopping_list_service__["a" /* ShoppingListService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__shopping_list_shopping_list_service__["a" /* ShoppingListService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__server_service__["a" /* ServerService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__server_service__["a" /* ServerService */]) === "function" && _b || Object])
], RecipeService);
...
/***/ "../../../../../src/app/recipes/server.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ServerService = (function () {
    function ServerService(http, authService) {
        this.http = http;
        this.authService = authService;
        this.dbUrl = 'https://aolpmt-cf7bb.firebaseio.com/recipes.json';
    }
    ServerService.prototype.saveRecipes = function (recipes) {
    ...
    ServerService.prototype.getRecipes = function () {
        var token = this.authService.getToken();
...
var ShoppingListService = (function () {
    function ShoppingListService() {
        this.ingredients = [
            ...
            new __WEBPACK_IMPORTED_MODULE_2__shared_ingredient_model__["a" /* Ingredient */]('Tomatoes', 10)
        ];
        this.ingredientAdded = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["Subject"]();
        this.itemmEditStarted = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["Subject"]();
    }
...
module.exports = "<form (ngSubmit)=\"onSignup(f)\" #f=\"ngForm\">\n  <div class=\"row\">\n    <div class=\"col-xs-12 col-sm-10 col-md-8 col sm-offset-1 col-md-offset-2\">\n      <div class=\"form-group\">\n        <label for=\"email\">Mail</label>\n        <input class=\"form-control\" type=\"email\" id=\"email\" name=\"email\" ngModel>\n      </div>\n\n      <div class=\"form-group\">\n        <label for=\"password\">Password</label>\n        <input class=\"form-control\" type=\"password\" id=\"password\" name=\"password\" ngModel>\n      </div>\n\n      <button class=\"btn btn-primary\" [disabled]=\"!f.valid\" type=\"submit\">Sign Up</button>\n    </div>\n  </div>\n</form>\n"
